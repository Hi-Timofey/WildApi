...
def create_app():
    ...
    from resources import UploadPhoto, PHOTOS_ENDPOINT, UploadVideo, VIDEOS_ENDPOINT
    ...
    api.add_resource(UploadPhoto,PHOTOS_ENDPOINT, f'{PHOTOS_ENDPOINT}/<id>')
    api.add_resource(UploadVideo, VIDEOS_ENDPOINT, f'{VIDEOS_ENDPOINT}/<id>')
